...
//       {/* Header */}
//       <motion.h2
//         className="text-4xl md:text-5xl font-bold text-center mb-10 bg-gradient-to-r from-cyan-400 via-blue-300 to-cyan-200 bg-clip-text text-transparent"
...
//       {/* Search Bar */}
//       <div className="relative w-full md:w-1/2 mx-auto mb-10">
//         <input
//           type="text"
...
//             <motion.div
//               key={m.mentor_id}
//               className="bg-gray-900/60 border border-cyan-400/30 rounded-2xl p-5 text-center shadow-[0_0_20px_rgba(0,255,255,0.1)] hover:shadow-[0_0_30px_rgba(0,255,255,0.3)] transition-all"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
...
//                 {m.mentor_name}
//               </h4>
//               <p className="text-sm text-gray-300">{m.designation}</p>
//               <p className="text-sm text-gray-400">{m.email}</p>
//               <p className="text-xs text-gray-400 italic mt-1">
//                 {m.tech_stack || "No tech stack listed"}
//               </p>
