...
const UsersDashboard = () => {
  ...
  const menuItems = [
    ...
    { name: "Abstract", icon: <IoFileTrayFull />, path: "abstract-submission" },
    // { name: "Services", icon: <GrServices />, path: "services" },
    // { name: "Contacts", icon: <RiContactsBookFill />, path: "contacts" },
  ];
  ...
  return (
    <div className="flex min-h-screen z-50 bg-gradient-to-br from-gray-900 via-black to-gray-950 transition duration-700">
      ...
      <div className="flex-1 relative">
        ...
        {/* Dynamic Content */}
        <div className="absolute top-0 left-0 w-full px-6 h-full overflow-y-auto">
