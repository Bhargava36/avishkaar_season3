...
const prizes = [
  { position: "3rd", amount: 10000, color: "from-orange-900 to-orange-400", labelColor: "text-orange-300" },
  { position: "1st", amount: 25000, color: "from-yellow-900 to-yellow-400", labelColor: "text-yellow-400" },
  { position: "2nd", amount: 15000, color: "from-gray-900 to-gray-400", labelColor: "text-gray-300" },
];

export default function OnlinePrizePool() {
