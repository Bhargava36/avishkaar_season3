...
// Styles for the neon cursor (using cyan-400)
const styles = `
...
const CustomCursorPage = () => {
  ...
  return (
    <div className="cursor-page bg-black hidden md:block">
...
//           alpha: 1,
//           color: ["#ffffff", "#80eaff", "#a855f7", "#38bdf8"][
//             Math.floor(Math.random() * 4)
//           ],
//         });
//       }
//       if (stars.current.length > 120) stars.current.splice(0, 40);
//     };
...
//         if (star.alpha <= 0) stars.current.splice(i, 1);
//       });
